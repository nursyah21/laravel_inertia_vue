        ...
        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
            <tr>
                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                    <h2 class="text-xl capitalize font-medium dark:text-white ">
                        ucup
                    </h2>
                </td>
                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                    <img class="object-cover w-24 h-24" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" alt="" />
                </td>
