                ...
                <div class="container px-4 mx-auto">
                    <div class="flex flex-col">
                        ...
                        <div class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                            ...
                            <div class="flex mt-6">
                                <button type="submit" class="w-full px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">create</button>
                            </div>
                            </form>
                        </div>
